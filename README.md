...
> Åbn denne side på [https://xmiackx.github.io/send-sms/](https://xmiackx.github.io/send-sms/)
...
* søg efter **https://github.com/xmiackx/send-sms**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/xmiackx/send-sms/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/xmiackx/send-sms**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/xmiackx/send-sms/raw/master/.github/makecode/blocks.png)
